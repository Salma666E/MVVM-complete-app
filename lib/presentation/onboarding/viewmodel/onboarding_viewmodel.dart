...
class OnBoardingViewModel extends BaseViewModel
  ...
  Stream<SliderViewObject> get outputSliderViewObject =>
      _streamController.stream.asBroadcastStream().map((sliderViewObject) {
        log(sliderViewObject.toString());
        return sliderViewObject;
      });

  // onboarding private functions
  void _postDataToView() {
    log('_list[_currentIndex]: ${_list[_currentIndex]}, length: ${_list.length}, _currentIndex: $_currentIndex');
